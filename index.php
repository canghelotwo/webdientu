...
<?php
	...
	include("include/danhmuc.php");
		...
		include("include/tkgia.php");
	}elseif($tam=='tkgia1'){
		include("include/tkgia1.php");
	}elseif($tam=='tkgia2'){
		include("include/tkgia2.php");
	}elseif($tam=='tkthuonghieu'){
		include("include/tkthuonghieu.php");
	}else {
		include("include/sanphammoi.php");
...
?>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">©DIENMAYDMT 2020 Electro Store. All rights reserved | Design by DMT
			</p>
		</div>
	</div>
	<!-- //copyright -->
