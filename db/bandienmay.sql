...
(44, 15, 'Laptop Asus', 10500000, 'asus.JPG', 4),
(45, 5, 'TV Toshiba', 25000000, 'tvtoshiba.jpg', 2);
...
(5, 'b10.jpg', 'Khuyến mãi', 1),
(6, 'b11.jpg', 'Khuyến mãi', 1);
...
--
ALTER TABLE `giohang`
  MODIFY `giohang_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `sanpham`
  MODIFY `sp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
