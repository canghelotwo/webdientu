...
<!-- page -->
	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
            ...
            <div class="row">
                    <?php
					$sql_baiviet=mysqli_query($mysqli,"select * from danhmuc_tin,baiviet where danhmuc_tin.danhmuctin_id=baiviet.danhmuctin_id and danhmuc_tin.danhmuctin_id='$id_danhmuc'");
