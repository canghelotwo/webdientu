...
<!-- page -->
		...
		<div class="agile_inner_breadcrumb">
			<div class="container" > 
				<ul class="w3_short">
                    ...
                    <?php 
                    $sql_tenbaiviet=mysqli_query($mysqli,"select * from baiviet where  baiviet_id='$id_baiviet'");
	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
            <!-- tittle heading -->
            <?php 
                    $sql_tenbaiviet1=mysqli_query($mysqli,"select * from baiviet where  baiviet_id='$id_baiviet'");
			...
			<!-- //tittle heading -->
            <?php
					$sql_baiviet=mysqli_query($mysqli,"select * from baiviet where baiviet.baiviet_id='$id_baiviet'");
