        ...
        <div class="row">
            ...
            <table class="table table-responsive table-bordered ">
                ...
                <tr>
                    ...
                    <td><a href="?mod=quanlybaiviet&xoa=<?php echo $row_bv['baiviet_id'] ?>">Xóa</a> | <a href="?mod=quanlybaiviet&quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>">Sửa</a></td>
                </tr>
                <?php
                }
                ?>
